...
class GroupCoordinatorAdapterTest {
  ...
  def testStreamsGroupInitialize(): Unit = {
    ...
    val ctx = makeContext(ApiKeys.STREAMS_GROUP_INITIALIZE, ApiKeys.STREAMS_GROUP_INITIALIZE.latestVersion)
